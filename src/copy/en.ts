  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'No. You invite your own base via a participation link. YVARS captures profiles and quotas on the entry form, then runs the interview. You keep the panel, the client file or the recruiter; YVARS keeps the voice and the analysis.',
      },
      {
